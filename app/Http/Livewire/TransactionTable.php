...
final class TransactionTable extends PowerGridComponent
{
    ...
    */
    ...
    {
        return Transaction::query()->with(['origin', 'destination']);
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('origin', function (Transaction $model)
            {
                return $model->origin->address;
            })
            ->addColumn('amount')
            // ->addColumn('fee')
            ->addColumn('reciept')
            ->addColumn('type')
            ->addColumn('destination', function (Transaction $model)
            {
                return $model->destination->address;
            })
            ->addColumn('status')
    ...
    */
    ...
    {
        return [
            Column::make('ID', 'receipt')->searchable(),
