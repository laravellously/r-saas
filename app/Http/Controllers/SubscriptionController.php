...
class SubscriptionController extends Controller
{
    ...
    {
        $this->vendor_auth_code = config('paddle.auth_code');
        $this->vendor_id = config('paddle.vendor');

        $this->paddle_checkout_url = (config('paddle.env') == 'sandbox') ? 'https://sandbox-checkout.paddle.com/api' : 'https://checkout.paddle.com/api';
