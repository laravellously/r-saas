<x-app-layout>
    <!-- Payment details -->
    <div class="m-8 space-y-6 sm:px-6 lg:px-0">
                        ...
                        <div class="grid grid-cols-4 gap-6 mt-6">
                            ...
                            <div class="col-span-4 sm:col-span-1">
                                <label for="security-code" class="flex items-center text-sm font-medium text-gray-700">
                                    ...
                                    <svg class="flex-shrink-0 w-5 h-5 ml-1 text-gray-300"
                        ...
                        <fieldset x-data="window.Components.radioGroup({ initialCheckedIndex: 1 })" x-init="init()">
                            ...
                            <div class="relative -space-y-px bg-white rounded-md">
                                ...
                                <label x-radio-group-option=""
                                    class="relative flex flex-col p-4 border cursor-pointer rounded-tl-md rounded-tr-md md:pl-4 md:pr-6 md:grid md:grid-cols-3 focus:outline-none"
                                    x-description="Checked: &quot;bg-cyan-50 border-cyan-200 z-10&quot;, Not Checked: &quot;border-gray-200&quot;"
                                    :class="{ 'bg-cyan-50 border-cyan-200 z-10': (value === 'Startup'), 'border-gray-200': !
                                            (value === 'Startup') }">
                                    <div class="flex items-center text-sm">
                                        <input type="radio" x-model="value" name="pricing-plan" value="Startup"
                                            class="w-4 h-4 border-gray-300 text-cyan-500 focus:ring-gray-900"
                                    ...
                                    <p id="pricing-plans-0-description-0"
                                        ...
                                        <span class="font-medium"
                                            x-description="Checked: &quot;text-cyan-900&quot;, Not Checked: &quot;text-gray-900&quot;"
                                            :class="{ 'text-cyan-900': (value === 'Startup'), 'text-gray-900': !(value ===
                                                    'Startup') }">$29
                                            / mo</span>
                                        <!-- space -->
                                        <span
                                            x-description="Checked: &quot;text-cyan-700&quot;, Not Checked: &quot;text-gray-500&quot;"
                                            :class="{ 'text-cyan-700': (value === 'Startup'), 'text-gray-500': !(value ===
                                                    'Startup') }">($290
                                            / yr)</span>
                                    </p>
                                ...
                                <label x-radio-group-option=""
                                    ...
                                    x-description="Checked: &quot;bg-cyan-50 border-cyan-200 z-10&quot;, Not Checked: &quot;border-gray-200&quot;"
                                    :class="{ 'bg-cyan-50 border-cyan-200 z-10': (value === 'Business'), 'border-gray-200':
                                            !(value === 'Business') }">
                                    <div class="flex items-center text-sm">
                                        <input type="radio" x-model="value" name="pricing-plan" value="Business"
                                            class="w-4 h-4 border-gray-300 text-cyan-500 focus:ring-gray-900"
                                    ...
                                    <p id="pricing-plans-1-description-0"
                                        ...
                                        <span class="font-medium"
                                            x-description="Checked: &quot;text-cyan-900&quot;, Not Checked: &quot;text-gray-900&quot;"
                                            :class="{ 'text-cyan-900': (value === 'Business'), 'text-gray-900': !(value ===
                                                    'Business') }">$99
                                            / mo</span>
                                        <!-- space -->
                                        <span
                                            x-description="Checked: &quot;text-cyan-700&quot;, Not Checked: &quot;text-gray-500&quot;"
                                            :class="{ 'text-cyan-700': (value === 'Business'), 'text-gray-500': !(value ===
                                                    'Business') }">($990
                                            / yr)</span>
                                    </p>
                                ...
                                <label x-radio-group-option=""
                                    class="relative flex flex-col p-4 border cursor-pointer rounded-bl-md rounded-br-md md:pl-4 md:pr-6 md:grid md:grid-cols-3 focus:outline-none"
                                    x-description="Checked: &quot;bg-cyan-50 border-cyan-200 z-10&quot;, Not Checked: &quot;border-gray-200&quot;"
                                    :class="{ 'bg-cyan-50 border-cyan-200 z-10': (value ===
                                        'Enterprise'), 'border-gray-200': !(value === 'Enterprise') }">
                                    <div class="flex items-center text-sm">
                                        <input type="radio" x-model="value" name="pricing-plan" value="Enterprise"
                                            class="w-4 h-4 border-gray-300 text-cyan-500 focus:ring-gray-900"
                                    ...
                                    <p id="pricing-plans-2-description-0"
                                        ...
                                        <span class="font-medium"
                                            x-description="Checked: &quot;text-cyan-900&quot;, Not Checked: &quot;text-gray-900&quot;"
                                            :class="{ 'text-cyan-900': (value === 'Enterprise'), 'text-gray-900': !(value ===
                                                    'Enterprise') }">$249
                                            / mo</span>
                                        <!-- space -->
                                        <span
                                            x-description="Checked: &quot;text-cyan-700&quot;, Not Checked: &quot;text-gray-500&quot;"
                                            :class="{ 'text-cyan-700': (value === 'Enterprise'), 'text-gray-500': !(value ===
                                                    'Enterprise') }">($2490
                                            / yr)</span>
                                    </p>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <a href="#" class="text-cyan-600 hover:text-cyan-900">View
                                                    receipt</a>
                                            </td>
                                        </tr>
