...
<section class="py-12 overflow-hidden bg-gray-50 md:py-20 lg:py-24">
    <div class="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <svg class="absolute transform top-full right-full translate-x-1/3 -translate-y-1/4 lg:translate-x-1/2 xl:-translate-y-1/2"
                ...
                <footer class="mt-8">
                    <div class="md:flex md:items-center md:justify-center">
                        ...
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            ...
                            <svg class="hidden w-5 h-5 mx-1 text-indigo-600 md:block" fill="currentColor"
                                viewBox="0 0 20 20">
