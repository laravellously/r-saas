<div class="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
    ...
    <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-cyan-700">
        ...
        <nav class="flex flex-col flex-1 mt-5 overflow-y-auto divide-y divide-cyan-800"
            aria-label="Sidebar">
            <div class="px-2 space-y-1">

                <a href="#"
                    class="flex items-center px-2 py-2 text-sm font-medium leading-6 text-white rounded-md bg-cyan-800 group"
